...
export const BoldMonoText = (props: TextProps) => {
  return (
    <Text {...props} style={[props.style, { fontFamily: FONTS.monoBold }]} />
  );
};

export const MediumMonoText = (props: TextProps) => {
  return (
    <Text {...props} style={[props.style, { fontFamily: FONTS.monoMedium }]} />
  );
};